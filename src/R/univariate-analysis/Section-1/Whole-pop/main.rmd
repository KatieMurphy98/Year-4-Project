...
\section{2.1  American Ninja Warrior, Part 1 - Y-Scaling}
...
```{r echo=F}
ggplot() +
  geom_density(data = as.data.frame(con_1_all), aes(x=con_1_all, col = "red"))+
  geom_density(data = as.data.frame(trn_1_all), aes(x=trn_1_all, col = "blue"))+
...
ggplot() +
  geom_density(data = as.data.frame(con_2_all), aes(x=con_2_all, col = "red"))+
  geom_density(data = as.data.frame(log_2_all), aes(x=log_2_all, col = "green"))+
  geom_density(data = as.data.frame(trn_2_all), aes(x=trn_2_all, col = "blue"))+
