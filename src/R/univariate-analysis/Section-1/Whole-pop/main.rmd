...
ggplot() +
  geom_density(data = as.data.frame(def_2_all), aes(x=def_2_all, col = "Default"))+
  geom_density(data = as.data.frame(wid_2_all), aes(x=wid_2_all, col = "Wide"))+
  geom_density(data = as.data.frame(nar_2_all), aes(x=nar_2_all, col = "Narrow"))+
