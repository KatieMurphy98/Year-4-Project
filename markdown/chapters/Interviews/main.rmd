...
Leading on to a discussion regarding the logarithmically scaled plots, Dr. Glynatsi now selected ggplot as producing the most publication ready plot, in her opinion, again referencing the 'floating' bars. It is noted that here, the bottom of the bar represents the value of 1 and thus the floating bar makes sense. However, \tetxit{"if you put those two plots next to 
