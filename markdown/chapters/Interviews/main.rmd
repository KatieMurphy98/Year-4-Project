...
Prior to the interview, questions were formulated in discussion with the project supervisor, who also partook as a respondent to certain questions in a 'test' interview, for which the transcript also contains discussion around the creation of the interview.
...
When asked about initial comments on the code,
