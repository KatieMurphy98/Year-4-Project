...
See appendix 1 for a pdf of the survey, containing the finished visuals, and appendices 2 and 3 for code. The R visualisations were created using R version 4.0.2 [@R] using ggplot2 version 3.3.3 [@ggplot]. The Python visualisations were made using Python version 3.7.4 [@py] with pyplot from matplotlib version 3.3.3 [@matplot]. 
