...
tab
```
Despite previously gauging the sizes of these bars or bar sections fairly accurately on the whole, most of the participants incorrectly judged that the obstacles were used an equal number of times, for both plots. 
