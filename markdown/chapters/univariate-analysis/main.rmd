...
This chapter will discuss basic univariate analysis of the survey results, including summary statistics and by eye comparisons between various subsets, such as language used and survey version number.
...
ggplot() +
  ...
  scale_colour_manual(name = " ", breaks = brks[1:2], values = vals[1:2])+
  theme_classic()
...
ggplot() +
  ...
  labs(x="Response", y="Density")+
  scale_colour_manual(name = " ", breaks = brks[3], values = vals[3])+
  theme_classic()
...
```{r, fig.cap = "Density plot showing distributions of responses regarding all three plots, after removing values greater or equal to 1000 from the responses fore the logarithmic plot"}
