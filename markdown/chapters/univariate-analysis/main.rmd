...
```{r fig.cap= "Table showing difference in the percieved difference for the logarithmic-scaled and truncated plots as compared to the control, for the two above questions"}
colnames(diff_mat) <- c("Con - Trnc", "Con - Log")
rownames(diff_mat) <- c("Log Grip vs Salmon Ladder", "Quintuple Steps vs Salmon Ladder")
kable(diff_mat)
```
...
This question was included for the purpose of testing whether, again, axix scaling impacts the precieved differences between values.
