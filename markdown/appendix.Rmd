...
\section{Appendix 2 - R Code for Visualisations}
...
\section{Appendix 3 - Python Code for Visualisations}
...
\section{Appendix 4 - Univariate Analysis Tables}
```{r include = FALSE}
rm(list=ls())
library(readxl)
library(dplyr)
...
\subsubsection{"Approximately many times would you say the `Salmon Ladder’ was used?"}
...
\subsubsection{Approximately how much more than `Log Grip' would you say `Salmon Ladder' was was used?}
...
\subsubsection{'Approximately how much more than `Quintuple Steps' would you say `Salmon Ladder' was used?'}
...
\subsubsection{"How large would you say the difference between `Jumping spider' and `Salmon Ladder' is?"}
...
\subsubsection{How large would you say the difference between `Log Grip' and `Floating Steps' is?}
...
\subsubsection{How many times would you say `Floating Steps' were used?}
...
\subsubsection{How many times would you say `Floating Steps' were used in the Finals (Regional/City) round?}
...
\subsubsection{How many times would you say 'Log Grip' was used in the Finals (Regional/City) round}
...
\subsubsection{Please select the statement you feel applies to the bar chart above.}
...
\subsubsection{Which obstacle do you think was used MORE in Finals (Regional/City) rounds, 'Log Grip' or 'Floating Steps'?}
...
\clearpage
\subsubsection{Which bar chart do you feel is easiest to read and interpret?}
```{r echo=F}
a_1 <- set_a$sta_grp
b_1 <- set_b$sta_grp
c_1 <- set_c$sta_grp
...
\subsubsection{Which colour scheme do you find most aesthetically pleasing?}
...
\subsubsection{Do you feel that one of the colour schemes makes it easier to read and interpret? If so, please select which one.}
...
\subsubsection{How much would you say sales of each company increased between January and December? [Company B]}
...
\subsubsection{How large would you say the drop in sales between April and July of Company A  is?}
...
\subsubsection{Based on the above graph, how large would you say the difference is between the number of sales Company C makes and the number of sales Company D makes?}
...
\section{Appendix 5 - 'black' and 'styler' Screenshots}
![Black to format Python \label{black}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/Black.PNG)

![Styler to format R \label{styler}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/stylr.jpg)

\section{Appendix 6 - R Screenshots}
![R Code for y-scaling Bar Plots \label{r_scale}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/r_code_screenshots/r_barplots1.jpg){height=28cm}
\newpage

![R Code for aspect ratio Bar Plots \label{r_aspect}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/r_code_screenshots/r_barplots2.jpg){height=28cm}

\newpage

![R Code for Stacked and Grouped Bar Plots \label{r_stacked}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/r_code_screenshots/r_barplots3.jpg)
![R Code for Line Plots \label{r_line}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/r_code_screenshots/r_lineplots.jpg)
\newpage

\section{Appendix 7 - Python Screenshots}
![Python Code for y-scaling Bar Plots \label{py_scale}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/py_code_screenshots/py_barplots1.jpg)
![Python Code for aspect ratio Bar Plots \label{py_aspect}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/py_code_screenshots/py_barplots2.jpg)
![Python Code for Stacked and Grouped Bar Plots (Part 1) \label{py_stacked_1}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/py_code_screenshots/py_barplots3.1.jpg){height=28cm}
\newpage

![Python Code for Stacked and Grouped Bar Plots (Part 2) \label{py_stacked_2}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/py_code_screenshots/py_barplots3.2.jpg){height=28cm}
\newpage
![Python Code for Line Plots \label{py_line}](C:/Users/Katie/OneDrive/Uni_Work_Year4/project/Year-4-Project/markdown/chapters/Interviews/py_code_screenshots/py_lineplots.jpg)

\section{Appendix 8 - Interview Transcripts}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/Transcriptions/andreas}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/Transcriptions/geraint}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/Transcriptions/henry}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/Transcriptions/nikoletta}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/Transcriptions/owen}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/Transcriptions/vince}

\newpage

\section{Appendix 9 - Summary of Interview Responses}
\includepdf[pages=-,nup=1,pagecommand={}]{C:/Users/Katie/OneDrive/Uni_Work_Year4/Project/Year-4-Project/markdown/chapters/Interviews/pre-writeup-analysis}
