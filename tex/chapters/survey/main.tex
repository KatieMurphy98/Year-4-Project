...
% Which other breed has the same weight as [BREED]?
% -> Show with logarithmic y-axis
% -> Show with logarithmic y-axis but in order
 
% Which other breed has the same height as [BREED]?
% -> Show with logarithmic y-axis
% -> Show with normal y-axis

% How many times was [OBSTACLE] used?
% -> Show scatter plot
% -> Show bar plot
